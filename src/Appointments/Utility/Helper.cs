...
namespace Appointments.Utility
{
    public static class Helper
    {
        ...
        public static string appointmentConfirm = "Appointment confirmed successfully.";
        ...
        public static string appointmentConfirmError = "Something went wront, Please try again.";
